...
static const _Msg1_type_support_symbol_names_t _Msg1_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_pkg1, msg, Msg1)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msg_pkg1, msg, Msg1)),
  }
};
...
{
  return &::msg_pkg1::msg::rosidl_typesupport_cpp::Msg1_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, msg_pkg1, msg, Msg1)() {
  return get_message_type_support_handle<msg_pkg1::msg::Msg1>();
}
