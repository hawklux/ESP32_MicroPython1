...
#ifndef MSG_PKG1__MSG__DETAIL__MSG1__STRUCT_HPP_
#define MSG_PKG1__MSG__DETAIL__MSG1__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__msg_pkg1__msg__Msg1 __attribute__((deprecated))
#else
# define DEPRECATED__msg_pkg1__msg__Msg1 __declspec(deprecated)
#endif
...
struct Msg1_
{
  ...
  // pointer types
  using RawPtr =
    msg_pkg1::msg::Msg1_<ContainerAllocator> *;
  using ConstRawPtr =
    const msg_pkg1::msg::Msg1_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<msg_pkg1::msg::Msg1_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<msg_pkg1::msg::Msg1_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      msg_pkg1::msg::Msg1_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<msg_pkg1::msg::Msg1_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<msg_pkg1::msg::Msg1_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<msg_pkg1::msg::Msg1_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<msg_pkg1::msg::Msg1_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__msg_pkg1__msg__Msg1
    std::shared_ptr<msg_pkg1::msg::Msg1_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__msg_pkg1__msg__Msg1
    std::shared_ptr<msg_pkg1::msg::Msg1_<ContainerAllocator> const>
...
using Msg1 =
  msg_pkg1::msg::Msg1_<std::allocator<void>>;
...
#endif  // MSG_PKG1__MSG__DETAIL__MSG1__STRUCT_HPP_
