...
bool msg_pkg1__msg__msg1__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_pkg1.msg._msg1.Msg1", full_classname_dest, 23) == 0);
  }
  msg_pkg1__msg__Msg1 * ros_message = _ros_message;
  {  // cmd_vel_linear
...
PyObject * msg_pkg1__msg__msg1__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_pkg1.msg._msg1");
