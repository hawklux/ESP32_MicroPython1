...
bool interface_pkg1__msg__message2__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_pkg1.msg._message2.Message2", full_classname_dest, 37) == 0);
  }
  interface_pkg1__msg__Message2 * ros_message = _ros_message;
  {  // center
...
{
  /* NOTE(esteve): Call constructor of Message2 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_pkg1.msg._message2");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Message2");
